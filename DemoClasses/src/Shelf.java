...
public class Shelf {
	...
	public static void main(String[] args) {
		...
		Book testBook = new Book("MyName", "MyTitle");
		
		System.out.println(testBook);
		
		
		ArrayList<Book> bookShelf = new ArrayList<Book>(); //notice difference in brackets
		// Difference Between Arrays and ArrayLists are:
		// - can only store objects (no int, double, boolean (primitive data) but it can store Integer)
		// - dynamicly sized, it grows with the need of your storage you don't have to set the size initially. 
		// - advanced data storage type that contains methods 
		...
		bookShelf.add(new GraphicNovel("X-men", "Stan Lee", "Jack Kirby"));
